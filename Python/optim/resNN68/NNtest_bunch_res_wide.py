...
from test_bunchofNewData_byNN_function_res68 import test_NewData_NN
...
best_model_path ='Python\\optim\\Settled_Model\\NNmodel_2_4\\model2.4.1.pth'



Data_origin = np.load("Python\\optim\\DataFromBPTK\\plasma68\\BPSplasma_init_Data_final.npy")  #输入数据
...
err28,mean_loss,label_rel_err_mean,mean_err,mean_r2,result_FromNN_Total,result_True_Total,result_FromNN_Total_Ajusted,result_True_Total_Ajusted = test_NewData_NN(origin_para = paras , model = bestmodel, model_path = best_model_path, Data = Data_origin, sampling_time_range = time_range)
