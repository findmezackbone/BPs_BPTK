...
def cost_function(theta):
    for j in range(0,4):
        ...
        result = BPS_BPTK(time,volunteer_ID =j,DSC_0 = theta[0], PFO_0 = theta[1], u1_0 = theta[2],mode = '63')
...
theta2 = minimize(fun = cost_function,x0 = theta_data ,method = "COBYLA",jac=None)
print(theta2)