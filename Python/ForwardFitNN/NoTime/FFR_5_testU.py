...
# 准备数据
y = np.load("Python\optim\DataFromBPTK\\urinebps5_1_add.npy")  #输入标签数据
...
best_model.load_state_dict(torch.load('Python\ForwardFitNN\Settled_Model\\threeTo5\\urine\model1.pth'))
