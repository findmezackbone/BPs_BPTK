...
# 准备数据
y = np.load("Python\optim\DataFromBPTK\\urinebpsg5_1_add.npy")  #输入标签数据
...
#超参数合集
hyperparas = {'input_dim':3,'hidden_dim':30,'hidden_nums':3,'output_dim':5,'block_layer_nums':3}
learning_rate = 0.001
num_epochs = 300
...
#best_model.load_state_dict(torch.load('Python\ForwardFitNN\Temporary_Model\model_pause1.pth'))
...
sampling_time_range = sampling_time_index/200 #采样时间节点，在0至75小时内共选取了5个时间节点 
